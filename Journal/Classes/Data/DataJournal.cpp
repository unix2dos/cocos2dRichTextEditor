...
CDataJournal::CDataJournal()
{
    ...
    vector<string> preview = {
        "Bike-sharing has been advocated by the government in recent years. It offers help to the people who is in a hurry to reach the destination soon, ",
